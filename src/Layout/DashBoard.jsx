...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard-container flex">
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 z-20 left-0 h-full bg-[#1d0153]  border-r-4 backdrop-blur-2xl text-white w-64 transition-transform overflow-y-auto transform ${
        ...
        <ul className="mt-2 ">
          ...
          {!isAdmin && !isModerator && (
            <>
              <li className="p-2 ">
                <NavLink
                  className={({ isActive }) =>
                    `flex items-center justify-start p-1 hover:bg-black  gap-2 ${
                      isActive
              ...
              <li className="p-2 ">
                <NavLink
                  className={({ isActive }) =>
                    `flex items-center p-1  justify-start hover:bg-black gap-2 ${
                      isActive
                        ? "font-extrabold text-yellow-500 "
                        : "text-white"
                    }`
              ...
              <li className="p-2 ">
                ...
                >
                  <FaChartPie></FaChartPie>My Analytics
                </NavLink>
              </li>
              <li className="p-2 ">
                <NavLink
          ...
          <li className="p-2 ">
            <NavLink
              className={({ isActive }) =>
                `flex items-center p-1  justify-start hover:bg-black gap-2 ${
                  isActive ? "font-extrabold text-yellow-500 " : "text-white"
                }`
              }
      ...
      {/* Main Content Area */}
      <div className={`main-content  transition-transform w-full `}>
        <Outlet></Outlet>
      </div>
    </div>
  );
