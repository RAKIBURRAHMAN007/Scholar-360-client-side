      ...
      <div className="md:flex  justify-between items-center w-4/5 bg-white bg-opacity-75 p-5 rounded-lg">
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className={theme === "dark" ? "text-black" : ""}>
            ...
            navigate the world of scholarships. Whether you’re seeking financial
            aid for your education or simply exploring opportunities, our
            user-friendly interface and powerful search features make it easy to
            discover the best scholarships available.
          </p>
        </div>
