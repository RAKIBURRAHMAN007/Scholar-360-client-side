        ...
        <div className="w-11/12 mx-auto mt-28 mb-16">
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="py-2 px-4 text-left border-r border-gray-300">Field</th>
                            <th className="py-2 px-4 text-left">Details</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Scholarship Category</td>
                            <td className="py-2 px-4">{Scholarship.scholarshipCategory}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Subject Category</td>
                            <td className="py-2 px-4">{Scholarship.subjectCategory}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Degree</td>
                            <td className="py-2 px-4">{Scholarship.degree}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Tuition Fees</td>
                            <td className="py-2 px-4">${Scholarship.tuitionFees}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Application Deadline</td>
                            <td className="py-2 px-4">{Scholarship.applicationDeadline}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Service Charge</td>
                            <td className="py-2 px-4">${Scholarship.serviceCharge}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Application Fees</td>
                            <td className="py-2 px-4">${Scholarship.applicationFees}</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4 font-semibold border-r border-gray-300">Post Date</td>
            ...
            {reviews.length > 0 && (
                <div className="mt-8">
                    ...
                    >
                        {reviews.map((review) => (
                            <SwiperSlide key={review._id} className="p-4 bg-gray-100 rounded-lg shadow">
